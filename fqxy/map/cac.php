...
/////////////////////////////////////////////////天降秘宝活动////////////////////////////////
    ...
    if ($wjddj<=300) {
        ...
        $vipqytime=10800;//多少时间更新3小时
        include("./wj/bossmb.php");//调用boss
    } else {
        echo "<font color=red>【上古神兽☯玄武】（世界boss）300以下参与</font>"."<br>";
    }
    //npc
    //cmd及超链接值
    $cmid=$cmid+1;
...
/////////////////////////////////////////////////天降秘宝活动////////////////////////////////
    ...
    if ($wjddj<=300) {
        ...
        $vipqytime=10800;//多少时间更新boss3小时
        include("./wj/bossmb.php");//调用boss
    } else {
        echo "<font color=red>【上古神兽☯朱雀】（世界boss）300以下参与</font>"."<br>";
    }
    //npc
