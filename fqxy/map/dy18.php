...
if ($dty==0) {
    ...
    if ($pdid1>=2&&$pdid2>=2&$pdid3>=2) {
        ...
        $clj[]=4;
        $npc[]=0;
        echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>进入【阴曹地府魔尊二层】</font></a>"."<br>";
    } else {
    }
    ...
    if ($pdid1>=2&&$pdid2>=2&$pdid3>=2) {
        ...
        $clj[]=4;
        $npc[]=0;
        echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>进入【阴曹地府魔尊三层】</font></a>"."<br>";
    } else {
    }
    ...
    if ($pdid1>=2&&$pdid2>=2&$pdid3>=2) {
        ...
        $clj[]=4;
        $npc[]=0;
        echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>进入【阴曹地府魔尊四层】</font></a>"."<br>";
    } else {
    }
    ...
    if ($pdid1>=2&&$pdid2>=2&$pdid3>=2) {
        ...
        $clj[]=4;
        $npc[]=0;
        echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>进入【阴曹地府魔尊五层】</font></a>"."<br>";
    } else {
    }
    $tttid=346;
    include("./rcrw/ttt.php");
    ...
    if ($pdid1>=2&&$pdid2>=2&$pdid3>=2) {
        ...
        $clj[]=4;
        $npc[]=0;
        echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>进入【阴曹地府魔尊六层】</font></a>"."<br>";
    } else {
    }
    ...
    if ($pdid1>=2&&$pdid2>=2&$pdid3>=2) {
        ...
        $clj[]=4;
        $npc[]=0;
        echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>进入【阴曹地府魔尊七层】</font></a>"."<br>";
    } else {
    }
    ...
    if ($pdid1>=2&&$pdid2>=2&$pdid3>=2) {
        ...
        $clj[]=4;
        $npc[]=0;
        echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>进入【阴曹地府魔尊八层】</font></a>"."<br>";
    } else {
    }
    ...
    if ($pdid1>=2&&$pdid2>=2&$pdid3>=2) {
        ...
        $clj[]=4;
        $npc[]=0;
        echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>进入【阴曹地府魔尊九层】</font></a>"."<br>";
    } else {
    }
    ...
    if ($pdid1>=2&&$pdid2>=2&$pdid3>=2) {
        ...
        $clj[]=4;
        $npc[]=0;
        echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>进入【阴曹地府魔尊十层】</font></a>"."<br>";
    } else {
    }
    ...
    $pdid3=($iniFile->getItem('活动次数', $tttpdid3));
    if ($pdid1>=2&&$pdid2>=2&$pdid3>=2) {
        echo "<font color=red>进入【阴曹地府混沌魔尊一层】（封印中）</font></a>"."<br>";
...
$clj[]=34;
$npc[]=0;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>进入【阴曹地府混沌魔尊一层】（封印中）</font></a>"."<br>";
*/
    } else {
    }
