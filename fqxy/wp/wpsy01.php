...
if ($npcc ==1) {//回城卷
    ...
    if ($ujnid=="挥砍") {
        ...
        //获取最大值
        $q2="jnn";
        $sql = "insert into $q2 (wjid,jnid,jndj)  values($wjid,'2','1')";
...
///缓存更新
    ...
    include("./sql/mysql.php");//调用数据库连接
    $q2="sw";
    $strsql = "update $q2 set swzz=$sw where wjid=$wjid and swid=13";//物品id号必改值
...
///缓存更新
    ...
    include("./sql/mysql.php");//调用数据库连接
    $q2="sw";
    $strsql = "update $q2 set swzz=$sw where wjid=$wjid and swid=9";//物品id号必改值
    $result = mysql_query($strsql);
...
///缓存更新
    ...
    include("./sql/mysql.php");//调用数据库连接
    $q2="sw";
    $strsql = "update $q2 set swzz=$sw where wjid=$wjid and swid=2";//物品id号必改值
    $result = mysql_query($strsql);
...
///缓存更新
    ...
    include("./sql/mysql.php");//调用数据库连接
    $q2="sw";
    $strsql = "update $q2 set swzz=$sw where wjid=$wjid and swid=5";//物品id号必改值
    $result = mysql_query($strsql);
...
///缓存更新
    ...
    include("./sql/mysql.php");//调用数据库连接
    $q2="sw";
    $strsql = "update $q2 set swzz=$sw where wjid=$wjid and swid=3";//物品id号必改值
    $result = mysql_query($strsql);
...
///缓存更新
    ...
    include("./sql/mysql.php");//调用数据库连接
    $q2="sw";
    $strsql = "update $q2 set swzz=$sw where wjid=$wjid and swid=6";//物品id号必改值
    $result = mysql_query($strsql);
...
///缓存更新
    ...
    include("./sql/mysql.php");//调用数据库连接
    $q2="sw";
    $strsql = "update $q2 set swzz=$sw where wjid=$wjid and swid=4";//物品id号必改值
    $result = mysql_query($strsql);
...
///缓存更新
    ...
    include("./sql/mysql.php");//调用数据库连接
    $q2="sw";
    $strsql = "update $q2 set swzz=$sw where wjid=$wjid and swid=11";//物品id号必改值
    $result = mysql_query($strsql);
...
///缓存更新
    ...
    include("./sql/mysql.php");//调用数据库连接
    $q2="sw";
    $strsql = "update $q2 set swzz=$sw where wjid=$wjid and swid=12";//物品id号必改值
    $result = mysql_query($strsql);
...
///缓存更新
    ...
    include("./sql/mysql.php");//调用数据库连接
    $q2="sw";
    $strsql = "update $q2 set swzz=$sw where wjid=$wjid and swid=10";//物品id号必改值
    $result = mysql_query($strsql);
...
///缓存更新
    ...
    include("./sql/mysql.php");//调用数据库连接
    $q2="sw";
    $strsql = "update $q2 set swzz=$sw where wjid=$wjid and swid=7";//物品id号必改值
    $result = mysql_query($strsql);
...
///缓存更新
    ...
    include("./sql/mysql.php");//调用数据库连接
    $q2="sw";
    $strsql = "update $q2 set swzz=$sw where wjid=$wjid and swid=1";//物品id号必改值
    $result = mysql_query($strsql);
