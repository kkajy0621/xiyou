...
//
    ...
    $rwlb = npc_rw($wjid, 5, $a1, $cmid, $cdid, $clj, $npc);
    echo $rwlb;
} elseif ($npcc==6) {
    ...
    $clj[]=10;
    $npc[]=$npcc;
    echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>攻击张二妈</font></a>"."<br>";
...
//echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>东海龙宫</font></a>"."<br>";
    ...
    $clj[]=10;
    $npc[]=$npcc;
    echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>攻击船夫</font></a>"."<br>";
...
//
    ...
    $clj[]=10;
    $npc[]=$npcc;
    echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>攻击店小二</font></a>"."<br>";
    if ($ii>1) {
        $i=0;
        for ($x=0;$x<=$m-1;$x++) {
            $i=$i+1;
...
*/
    ...
    if (!empty($npcxx)) {
        echo "<span style='color: red;'>{$npcxx['mz']}</span><br>";
        echo "<span style='color: black'>{$npcxx['ms']}</span><br>";
        $cmid=$cmid+1;
        $cdid[]=$cmid;
        $clj[]=10;
        $npc[]=$npcc;
        echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>攻击{$npcxx['mz']}</font></a>"."<br>";
        echo npc_rw($wjid, $npcxx['id'], $a1, $cmid, $cdid, $clj, $npc);
    } else {
