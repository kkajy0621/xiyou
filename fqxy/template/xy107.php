...
BUG，相信一定逃不过大家的火眼精金的！</font><br>";
    ...
    echo "<br>";
    echo "<font color=black>3.另外游戏内测期间不提供任何游戏道具为了测试游戏的稳定性，充值系统采用幻想西游独家编写的自助充值暂时只能用支付宝
，充值的实际价格为正常价格的100分之1，也是为了测试充值系统的重要性，当然内测充值的按照内测充值的实际金额返还在游戏上线后的金额</font><br>";
    ...
    echo "<br>";
} elseif ($ckid ==10) {//【活动-幻想西游公测冲榜奖励活动】
    ...
    echo "<font color=black>第10名以外无奖励</font>"."<br>";
    echo "<font color=red>---------------等级榜-------------</font><br>";
} elseif ($ckid ==11) {//【活动-幻想西游公测充值消费活动】
    ...
    echo "<br>";
} elseif ($ckid ==12) {//【活动-幻想西游推广计划奖励活动】
    ...
    echo "<font color=red>游戏群：待添加</font><br>";
    echo "<font color=red>提示：如果网址不能进请加群联系广大西游爱好者</font><br>";
    echo "<font color=red>游戏社区地址：待添加</font><br>";
    echo "<font color=red>更多精彩尽在WAP游戏社区：待添加</font><br>";
} elseif ($ckid ==13) {//【活动-幻想西游内测奖励活动】
    echo "<font color=black>幻想西参与内测奖励</font><br>";
    echo "<font color=black>正在紧张统计中明日发放！！</font><br>";
} elseif ($ckid ==14) {//【幻想西游公测开区元老一览】
    echo "<font color=black>幻想西游开区由下面三位大佬的鼎力相助（幻想西游提供游戏技术支持）</font><br>";
...
// echo "<br>";
} elseif ($ckid ==18) {//【活动公告】暑期活动第一波（7.3-7.10晚8点结束）
    echo "<font color=red>活动时间2022.7.3-2022.7.10晚8点</font><br>";
    ...
    echo "<font color=black>称号，豹子ID号卡一张〖金豆〗1000</font><br>";
    ...
    echo "<font color=black>称号，前单后豹子ID号卡一张〖金豆〗400</font><br>";
...
} elseif ($ckid ==19) { //【活动公告】暑期活动第二波（7.14-7.24晚8点结束）
    echo "<font color=red>活动时间2022.7.14-2022.7.24晚8点</font><br>";
    ...
    echo "<br>";
} elseif ($ckid ==20) {//【活动公告】暑期活动第三波7.27-8.3晚0点结束（7.3-7.10晚8点结束）
    echo "<font color=red>活动时间2022.7.27-2022.8.3——0点结束</font><br>";
    ...
    echo "<br>";
    echo "<font color=black>10.活动期间累计充值称号大放送</font><br>";
    ...
    echo "<br>";
} elseif ($ckid ==21) {//【活动-至尊宝与紫霞仙子】（8.4-8.15晚24点结束）
    ...
    echo "<font color=black>3.再此说NO~~终于黄天不负有心人。幻想西游GM发现了开启五级变异圣品的秘密，还是原来的配方不一样的味道（活动期间充值满1000赠送五级变异圣品猴子，满2000送绝版五级变异圣品麒麟圣祖一只）</font><br>";
...
} elseif ($ckid ==22) {//【活动-浪漫七夕】（8.17-8.25晚24点结束）
    ...
    echo "<br>";
} elseif ($ckid ==23) {//【活动-开学活动】(8-27~~~9-2(23:50))
    ...
    echo "<font color=black>满2000送蓝练星x300</font><br>";
    echo "<br>";
    echo "<font color=red>6.开学活动期间累计充值称号〖金豆〗大放送</font><br>";
    echo "<font color=black>第一名（送10000〖金豆〗）</font>";
    //cmd及超链接值
    $cmid=$cmid+1;
    $cdid[]=$cmid;
    $clj[]=400;
    ...
    echo "<br>";
    echo "<font color=black>第二名（送6000〖金豆〗）</font>";
    //cmd及超链接值
    $cmid=$cmid+1;
    $cdid[]=$cmid;
    $clj[]=400;
    ...
    echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>〖进击の一骑绝尘〗</font></a>";
    echo "<br>";
    echo "<font color=black>第三名（送3000〖金豆〗）</font>";
    //cmd及超链接值
    $cmid=$cmid+1;
    $cdid[]=$cmid;
    $clj[]=400;
    ...
    echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>〖进击の一骑绝尘〗</font></a>";
    echo "<br>";
    echo "<font color=black>第4名（1000〖金豆〗）</font>";
    echo "<br>";
    echo "<font color=black>第5名（600〖金豆〗）</font>";
    echo "<br>";
    echo "<font color=black>第6名（300〖金豆〗）</font>";
    echo "<br>";
    echo "<font color=black>第7名（200〖金豆〗）</font>";
    echo "<br>";
    echo "<font color=black>第8名（100〖金豆〗）</font>";
    echo "<br>";
    echo "<font color=black>第9名（50〖金豆〗）</font>";
    echo "<br>";
    echo "<font color=black>第10名（30〖金豆〗）</font>";
    echo "<br>";
    ...
    echo "<font color=black>第一名（送5000〖金豆〗）</font>";
    //cmd及超链接值
    $cmid=$cmid+1;
    $cdid[]=$cmid;
    $clj[]=400;
    ...
    echo "<br>";
    echo "<font color=black>第二名（送3000〖金豆〗）</font>";
    //cmd及超链接值
    $cmid=$cmid+1;
    $cdid[]=$cmid;
    $clj[]=400;
    ...
    echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>〖震古烁今〗</font></a>";
    echo "<br>";
    echo "<font color=black>第三名（送1000〖金豆〗）</font>";
    //cmd及超链接值
    $cmid=$cmid+1;
    $cdid[]=$cmid;
    $clj[]=400;
    ...
    echo "<br>";
    echo "<br>";
    echo "<font color=black>第4名（500〖金豆〗）</font>";
    echo "<br>";
    echo "<font color=black>第5名（400〖金豆〗）</font>";
    echo "<br>";
    echo "<font color=black>第6名（300〖金豆〗）</font>";
    echo "<br>";
    echo "<font color=black>第7名（200〖金豆〗）</font>";
...
} elseif ($ckid ==24) {//【活动-往日活动重启】(9-3~~~9-10(23:50))
    echo "<font color=red>1.消费赠送</font><br>";
    echo "<font color=black>充值消费赠送独家装备【诛仙套】祝你在西游路上杀妖除魔。100元〖诛仙武器令〗x1，200元〖诛仙盔甲令〗x1，300元〖诛仙头盔令〗x1，300元〖诛仙鞋子令〗x1，400元〖诛仙项链令〗x1，500元〖诛仙手镯令〗x1（可以折为金豆每件200豆豆）</font><br>";
    echo "<font color=red>2.千万声望法宝送不停</font><br>";
    echo "<font color=black>100：〖1万西游声望卷轴〗x20〖1万法宝经验卷轴〗x20</font><br>";
...
} elseif ($ckid ==25) {//【活动-中秋活动】(9-9~~~9-17(23:50))
    ...
    echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>〖进击の一骑绝尘〗</font></a>";
    echo "<br>";
    echo "<font color=black>第二名（送4000〖金豆〗）</font>";
    //cmd及超链接值
    $cmid=$cmid+1;
    $cdid[]=$cmid;
    $clj[]=400;
    ...
    echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>〖进击の一骑绝尘〗</font></a>";
    echo "<br>";
    echo "<font color=black>第三名（送1200〖金豆〗）</font>";
    //cmd及超链接值
    $cmid=$cmid+1;
    $cdid[]=$cmid;
    $clj[]=400;
    ...
    echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>〖进击の一骑绝尘〗</font></a>";
    echo "<br>";
    echo "<font color=black>第4名（777〖金豆〗）</font>";
    echo "<br>";
    echo "<font color=black>第5名（520〖金豆〗）</font>";
    echo "<br>";
    echo "<font color=black>第6名（400〖金豆〗）</font>";
    echo "<br>";
    echo "<font color=black>第7名（300〖金豆〗）</font>";
    echo "<br>";
    echo "<font color=black>第8名（220〖金豆〗）</font>";
    echo "<br>";
    echo "<font color=black>第9名（150〖金豆〗）</font>";
    echo "<br>";
    echo "<font color=black>第10名（100〖金豆〗）</font>";
    echo "<br>";
    echo "<br>";
    ...
    echo "<br>";
    echo "<font color=red>5.充值满10赠送〖嫦娥月饼礼盒〗x1，【糯米粉】x100，【桂花糕】x5</font><br>";
    echo "<br>";
    echo "<font color=red>6.充值返利（当天充值〖金豆〗的百分比充得多返得多）</font>";
    ...
    echo "<font color=black>备注：具体各项贵族月卡信息参照游戏福利界面</font><br>";
    echo "<br>";
    echo "<font color=red>11.充值送【小宇宙】，掉宝，宝石，陨符</font><br>";
    echo "<font color=black>满100送【小宇宙】x1000，四倍掉宝2张，圣贤宝石1颗，金符10张</font><br>";
    echo "<font color=black>满200送【小宇宙】x2000，四倍掉宝5张，八倍掉宝2张，圣贤宝石3颗，金符30张</font><br>";
    echo "<font color=black>满500送【小宇宙】x8000，四倍掉宝15张，八倍掉宝5张，圣贤宝石10颗，金符20张，钻符5张</font><br>";
    echo "<font color=black>满1000送【小宇宙】x20000，送四倍掉宝40张，八倍掉宝15张，圣贤宝石20颗，陨符3张，金符20张，钻符15张</font><br>";
    echo "<font color=black>满2000送【小宇宙】x50000，四倍掉宝100张，八倍掉宝50张，圣贤宝石50颗，陨符10张，，金符50张，钻符35张</font><br>";
    echo "<br>";
} elseif ($ckid ==26) {//【活动-花果山新区活动】(9-16~~~9-25(23:50))
    echo "<font color=black>幻想西游公测活动如下：</font><br>";
    ...
    echo "<font color=black>3.昔日活动重启（具体在十字上）各大副本掉落活动材料，天降秘宝，通天塔，阴曹地府，诛仙台产出</font><br>";
    ...
    echo "<br>";
    echo "<font color=red>8.国庆期充值对应金额送对应金额〖云梯石〗送国庆字</font><br>";
    echo "<font color=black>10元送4个〖云梯石〗【小宇宙】x50【国庆金铲】x5〖国庆万能字〗x20</font><br>";
    echo "<font color=black>20元送10个〖云梯石〗【小宇宙】x120【国庆金铲】x15〖国庆万能字〗x50</font><br>";
    echo "<font color=black>50元送30个〖云梯石〗【小宇宙】x300【国庆金铲】x40〖国庆万能字〗x150，〖圣贤宝石〗x1</font><br>";
    echo "<font color=black>100元送100个〖云梯石〗【小宇宙】x800【国庆金铲】x100〖国庆万能字〗x400〖圣贤宝石〗x3【凤凰圣祖】x1〖如意の称号宝箱〗x1</font><br>";
    echo "<font color=black>200元送288个〖云梯石〗【小宇宙】x2000【国庆金铲】x300〖国庆万能字〗x1000〖圣贤宝石〗x7【凤凰圣祖】x2〖如意の称号宝箱〗x3</font><br>";
    echo "<font color=black>500元送888个〖云梯石〗【小宇宙】x6000【国庆金铲】x800〖国庆万能字〗x3000〖圣贤宝石〗x20【凤凰圣祖】x5〖如意の称号宝箱〗x8</font><br>";
    echo "<font color=black>1000元送3000个〖云梯石〗【小宇宙】x15000【国庆金铲】x2000〖国庆万能字〗x8888〖圣贤宝石〗x50【凤凰圣祖】x10〖如意の称号宝箱〗x18</font><br>";
    echo "<font color=black>2000元送5000个〖云梯石〗【小宇宙】x35000【国庆金铲】x5000〖国庆万能字〗x20000〖圣贤宝石〗x120【凤凰圣祖】x20〖如意の称号宝箱〗x40</font><br>";
    echo "<font color=red>备注：以上物品直接发放对应的充值礼包打开即可获得</font><br>";
    echo "<br>";
    echo "<font color=black>9.活动期间充值满500送五变五圣【凤凰圣祖】一只（每个账号仅此一次）</font><br>";
    echo "<br>";
    echo "<font color=red>10.国庆期充值榜送充值卡或〖金豆〗（需要结束后结算）</font><br>";
    echo "<font color=black>第1名：【2000元自充卡】+5000个〖云梯石〗（需要满足2000国庆充值积分）</font><br>";
    echo "<font color=black>第2名：【1000元自充卡】+2000个〖云梯石〗（需要满足1000国庆充值积分）</font><br>";
    echo "<font color=black>第3名：【500元自充卡】+1000个〖云梯石〗（需要满足500国庆充值积分）</font><br>";
    echo "<font color=black>第4名：【200元自充卡】+600个〖云梯石〗（需要满足200国庆充值积分）</font><br>";
    echo "<font color=black>第5名：【100元自充卡】+300个〖云梯石〗（需要满足100国庆充值积分）</font><br>";
    echo "<font color=black>第6名：【50元自充卡】+150个〖云梯石〗（需要满足50国庆充值积分）</font><br>";
    echo "<font color=black>第7名：【20元自充卡】+90个〖云梯石〗（需要满足20国庆充值积分）</font><br>";
    echo "<font color=black>第8名：【10元自充卡】+60个〖云梯石〗（需要满足10国庆充值积分）</font><br>";
    echo "<font color=black>第9名：〖金豆〗x100+40个〖云梯石〗（需要满足10国庆充值积分）</font><br>";
    echo "<font color=black>第10名：〖金豆〗x50+20个〖云梯石〗（需要满足10国庆充值积分）</font><br>";
    echo "<font color=red>备注：如果充值名次满足但积分不满足的话则往下名退，退到满足的为止，如退到的名次有玩家占领则该玩家往下退，以此类推</font><br>";
    echo "<br>";
    echo "<font color=red>11.国庆期积分榜送〖云梯石〗</font><br>";
    echo "<font color=black>第1名：1000个〖云梯石〗</font><br>";
    echo "<font color=black>第2名：800个〖云梯石〗</font><br>";
    echo "<font color=black>第3名：600个〖云梯石〗</font><br>";
    echo "<font color=black>第4名：400个〖云梯石〗</font><br>";
    echo "<font color=black>第5名：200个〖云梯石〗</font><br>";
    echo "<font color=black>第6名：100个〖云梯石〗</font><br>";
    echo "<font color=black>第7名：60个〖云梯石〗</font><br>";
    echo "<font color=black>第8名：40个〖云梯石〗</font><br>";
    ...
    echo "<br>";
} elseif ($ckid ==29) {//【活动-西游半周年嘉年华】（10.10-10.16晚23点50结束）
    echo "<font color=red>活动时间2022.10.10-2022.10.16</font><br>";
    echo "<br>";
...
备注：满后面的则把前面赠送的一起拿掉</font><br>";
    ...
    echo "<br>";
} elseif ($ckid ==31) {//【活动-万圣节活动】（11.02-11.15晚23点50结束）
    echo "<font color=red>活动时间2022.11.02-2022.11.15</font><br>";
    echo "<br>";
    ...
    echo "<font color=black>6.充值（累计）满100送〖比翼双飞〗（典藏套装）套装，满200送【喜鹊令】x2，满500送〖七夕令〗x2，满1000送〖七夕令〗x4（需告知gm是否需要，不需要则转换为金豆1元=5豆）</font><br>";
    echo "<br>";
...
备注：满后面的则把前面赠送的一起拿掉</font><br>";
...
} elseif ($ckid ==32) {//【活动-乌鸡国新区活动】（11.02-11.15晚23点50结束）
    echo "<font color=red>活动时间2022.11.02-2022.11.15</font><br>";
    ...
    echo "<font color=black>第10名以外无奖励</font>"."<br>";
    echo "<font color=red>---------------等级榜-------------</font><br>";
} elseif ($ckid ==33) {//【活动-感恩节活动】（11.17-11.24晚23点50结束）
    ...
    echo "<br>";
} elseif ($ckid ==34) {//【活动-【傲来国】活动】(11-26~~~12-02(23:50))
    ...
    echo "<font color=black>第10名以外无奖励</font>"."<br>";
    echo "<font color=red>---------------等级榜-------------</font><br>";
} elseif ($ckid ==35) {//【活动-【宝象国】活动】(11-26~~~12-02(23:50))
    echo "<font color=red>活动时间11-26~~~12-02(23:50)</font><br>";
