...
if ($zsspd == 1) {
    ...
    */
    ...
    /*
        ...
        $clj[]=107;
        $npc[]=12;
        echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>【活动-幻想西游推广奖励活动】</font></a>" . "<br>";
    ...
    */
    ...
    /*
        ...
        $clj[]=107;
        $npc[]=34;
        echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>【活动-傲来国开区活动】(2022.10.1至10.8晚24点结束）</font></a>" . "<br>";
    */
