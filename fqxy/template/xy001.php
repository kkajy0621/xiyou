...
$clj[]=107;
$npc[]=10;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>【活动-幻想西游公测冲榜奖励活动】</font></a>" . "<br>";
...
$clj[]=107;
$npc[]=11;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>【活动-幻想西游公测充值消费活动】</font></a>" . "<br>";
...
$clj[]=107;
$npc[]=12;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>【活动-幻想西游推广计划奖励活动】</font></a>" . "<br>";
...
$clj[]=107;
$npc[]=13;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>【活动-幻想西游内测奖励活动】</font></a>" . "<br>";
...
$clj[]=107;
$npc[]=14;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>【幻想西游公测开区元老一览】</font></a>" . "<br>";
...
$clj[]=107;
$npc[]=18;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>【活动公告】暑期活动第一波（7.3-7.10晚8点结束）</font></a>" . "<br>";
...
$clj[]=107;
$npc[]=19;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>【活动公告】暑期活动第二波（7.14-7.24晚8点结束）</font></a>" . "<br>";
...
$clj[]=107;
$npc[]=20;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>【活动公告】暑期活动第三波7.27-8.3晚0点结束（7.3-7.10晚8点结束）</font></a>" . "<br>";
...
$clj[]=107;
$npc[]=34;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>【活动-【傲来国】活动】(11-26~~~12-02(23:50))</font></a>" . "<br>";
...
$clj[]=107;
$npc[]=35;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>【活动-【宝象国】活动】(11-26~~~12-02(23:50))</font></a>" . "<br>";
...
$clj[]=107;
$npc[]=36;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>【活动-开区活动】(傲来国宝象国同时有效)</font></a>" . "<br>";
*/
...
echo "<span>【客服帮助】</span><br/>" . "<span>官方QQ群:待添加</span><br/>";
flock($fp, LOCK_UN);
} else {
echo "服务器开小差了";
}
